...
class DCGAN(object):
    ...
    def test(self, config=None):
        ...
        for z_idx in range(config.z_dim):
            ...
            scipy.misc.imsave('/home/yuncao/Document/result/image_Y.png', inverse_transform(image_Y[0].squeeze()))
            scipy.misc.imsave('/home/yuncao/Document/result/image_U.png', inverse_transform(image_U[0].squeeze()))
            scipy.misc.imsave('/home/yuncao/Document/result/image_V.png', inverse_transform(image_V[0].squeeze()))
